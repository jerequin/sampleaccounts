								...
								<div id="cbxaccounting_addexpinc_wrap">
									<?php if($show_file_manager): ?>
										<ul id="cbxaccounting_addexpinc_nav" class="nav nav-tabs ">
											<li class="active"><a href="#cbxaccounting_addexpinc_edit"><?php esc_html_e( 'Expense/Income Entry', 'cbxwpsimpleaccounting' ); ?></a></li>

											<li><a href="#cbxaccounting_addexpinc_attachments"><?php esc_html_e( 'File Attachments', 'cbxwpsimpleaccounting' ); ?></a></li>
									...
									<div id="cbxaccounting_addexpinc_tabs">
										<div id="cbxaccounting_addexpinc_edit" class="cbxaccounting_addexpinc_tab  active">
											<form id="cbacnt-expinc-form" class="form-horizontal" action="" method="post"
                                                ...
                                                <textarea id="cbacnt-exinc-note" name="cbacnt-exinc-note"
													...
													<div class="form-group">
														...
														<div class="col-sm-10 error_container">
															<input name="cbacnt-exinc-tax" id="cbacnt-exinc-tax" class="form-control" type="text"
										...
										<?php if($show_file_manager): ?>
											<div id="cbxaccounting_addexpinc_attachments" class="cbxaccounting_addexpinc_tab">
												<?php
